...
class dreamStartSceneGenerator {
    ...
    GenDreamStartScene() {
        ...
        async function startMainDreamMenu(ctx) {
            await ctx.reply( fistText ,
                {
                    reply_markup: {
                        inline_keyboard: [
                            [
                            {text: 'СТАРТ', callback_data: 'data_dream'}
                            ],
        ...
        const fistText =  'Вас приветствует чат-бот, готовый помочь в решении ваших проблем со сном ребенка. \n' +
